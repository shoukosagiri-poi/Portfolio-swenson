...
<html lang="en" class="scroll-smooth">
  <head>
    ...
    <title>Swenson Simanjuntak | Portfolio</title>
    <meta name="description" content="Hai semua 👋, Perkenalkan nama saya Swenson Simanjuntak. ini merupakan web profile saya yang menggunakan Tailwind CSS." />
    <meta property="og:image" content="dist/img/istri2.png" />
    <link rel="icon" href="dist/img/iconweb.png" />
    ...
    <header class="absolute top-0 left-0 z-10 flex w-full items-center bg-transparent">
      <div class="container">
        <div class="relative flex items-center justify-between">
          <div class="px-4">
            <a href="#home" class="block py-6 text-lg font-bold text-primary">Swenson Simanjuntak</a>
          </div>
      ...
      <div class="container">
        <div class="flex flex-wrap">
          <div class="w-full self-center px-4 lg:w-1/2">
            <h1 class="text-base font-semibold text-primary md:text-xl">Halo Semua 👋, saya <span class="mt-1 block text-4xl font-bold text-dark dark:text-white lg:text-5xl">Swenson Simanjuntak</span></h1>
            <h2 class="mb-5 text-lg font-medium text-secondary lg:text-2xl">shoukosagiri-poi</h2>
            <p class="mb-10 font-medium leading-relaxed text-secondary">No Anime No Life dekkk.</p>
          ...
          <div class="w-full self-end px-4 lg:w-1/2">
            <div class="relative mt-10 lg:right-0 lg:mt-9">
              <img src="dist/img/istri.png" alt="Istri Swenson" class="relative z-10 mx-auto max-w-full" />
      ...
      <div class="container">
        <div class="flex flex-wrap">
          <div class="mb-10 w-full px-4 lg:w-1/2">
            ...
            <h2 class="mb-5 max-w-md text-3xl font-bold text-dark dark:text-white lg:text-4xl">Nggak ada :V!</h2>
            <p class="max-w-xl text-base font-medium text-secondary lg:text-lg">bingung mau ketik apa:V!</p>
          </div>
          <div class="w-full px-4 lg:w-1/2">
            <h3 class="mb-4 text-2xl font-semibold text-dark dark:text-white lg:pt-10 lg:text-3xl">Sosmed</h3>
            ...
            <div class="flex items-center">
              ...
              >
              <svg role="img" width="20" class="fill-current" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
  ...
  <path d="M16 8A8 8 0 1 1 0 8a8 8 0 0 1 16 0zM8.287 5.906c-.778.324-2.334.994-4.666 2.01-.378.15-.577.298-.595.442-.03.243.275.339.69.47l.175.055c.408.133.958.288 1.243.294.26.006.549-.1.868-.32 2.179-1.471 3.304-2.214 3.374-2.23.05-.012.12-.026.166.016.047.041.042.12.037.141-.03.129-1.227 1.241-1.846 1.817-.193.18-.33.307-.358.336a8.154 8.154 0 0 1-.188.186c-.38.366-.664.64.015 1.088.327.216.589.393.85.571.284.194.568.387.936.629.093.06.183.125.27.187.331.236.63.448.997.414.214-.02.435-.22.547-.82.265-1.417.786-4.486.906-5.751a1.426 1.426 0 0 0-.013-.315.337.337 0 0 0-.114-.217.526.526 0 0 0-.31-.093c-.3.005-.763.166-2.984 1.09z"/>
              ...
              <!-- Instagram -->
              <a
                href="https://www.instagram.com/shoukosagiri.poi/"
                target="_blank"
                class="mr-3 flex h-9 w-9 items-center justify-center rounded-full border border-slate-300 text-slate-300 hover:border-primary hover:bg-primary hover:text-white"
              >
              ...
              <!-- Twitter -->
              <a
                href="https://twitter.com/shouko_sagiri"
                target="_blank"
                class="mr-3 flex h-9 w-9 items-center justify-center rounded-full border border-slate-300 text-slate-300 hover:border-primary hover:bg-primary hover:text-white"
              >
                <svg role="img" width="20" class="fill-current" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
              ...
              <!-- TikTok -->
              <a
                href="https://www.tiktok.com/@shouko.sagiri"
                target="_blank"
                class="mr-3 flex h-9 w-9 items-center justify-center rounded-full border border-slate-300 text-slate-300 hover:border-primary hover:bg-primary hover:text-white"
              >
                <svg role="img" width="20" class="fill-current" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
              ...
              <!-- LinkedIn -->
              <a
                href="https://www.linkedin.com/in/shoukosagiri"
                target="_blank"
                class="mr-3 flex h-9 w-9 items-center justify-center rounded-full border border-slate-300 text-slate-300 hover:border-primary hover:bg-primary hover:text-white"
              >
                <svg role="img" width="20" class="fill-current" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
      ...
      <div class="container">
        ...
        <div class="flex w-full flex-wrap justify-center px-4 xl:mx-auto xl:w-10/12">
          <div class="mb-12 p-4 md:w-1/2">
            ...
            <h3 class="mt-5 mb-3 text-xl font-semibold text-dark dark:text-white">Landing Page Swenson Simanjuntak</h3>
            <p class="mt-5 mb-3 text-base font-medium text-secondary">Website utama saya dengan embed youtube yang berubah-ubah.</p>
            <a href="https://swenson.my.id" class="rounded-lg bg-primary py-2 px-4 text-sm font-medium text-white hover:opacity-80">Check Disini</a>
          </div>
          <div class="mb-12 p-4 md:w-1/2">
            <div class="overflow-hidden rounded-md shadow-md">
              <img src="dist/img/portfolio/2.png" alt="Roother Whatsapp Bot" width="w-full" />
            </div>
            <h3 class="mt-5 mb-3 text-xl font-semibold text-dark dark:text-white">Roother Whatsapp Bot</h3>
            <p class="mt-5 mb-3 text-base font-medium text-secondary">Sebuah pemograman javascript yang memakai library <a href="https://github.com/adiwajshing/Baileys" target="_blank" style="color: rgb(18, 241, 18) ; text-shadow: 1cm;">Baileys</a> untuk bagian utama whatsapp bot.</p>
            <a href="https://wa.me/6283111322009" class="rounded-lg bg-primary py-2 px-4 text-sm font-medium text-white hover:opacity-80">Check Disini</a>
          </div>
          <div class="mb-12 p-4 md:w-1/2">
            <div class="overflow-hidden rounded-md shadow-md">
      ...
      <div class="container">
        <div class="w-full px-4">
          <div class="mx-auto mb-16 max-w-xl text-center">
            ...
            <h2 class="mb-4 text-3xl font-bold text-dark dark:text-white sm:text-4xl lg:text-5xl">Ingin melihat blog saya?</h2>
            <p class="text-md font-medium text-secondary md:text-lg">Kamu bisa melihat blog saya di website utama saya, atau bisa klik tombol berikut</p>
          </div>
        </div>
      
        <div class="w-full px-1">
          <div class="mx-auto mb-16 max-w-xl text-center">
            <a href="https://swenson.my.id/blog" class="w-full rounded-full bg-primary py-3 px-8 text-base font-semibold text-white transition duration-500 hover:opacity-80 hover:shadow-lg">Blog Saya</a>
          </div>
        </div>
      </div>
    </section>
      ...
      <div class="container">
        <div class="w-full px-4">
          <div class="mx-auto mb-16 max-w-xl text-center">
            ...
            <p class="text-md font-medium text-secondary md:text-lg">Jika ada yang ingin disampaikan, silahkan isi forum di bawah.</p>
          </div>
        </div>
      ...
      <div class="container">
        <div class="flex flex-wrap">
          <div class="mb-12 w-full px-4 font-medium text-slate-300 md:w-1/3">
            <h2 class="mb-5 text-4xl font-bold text-white">ShoukoSagiri</h2>
            <h3 class="mb-2 text-2xl font-bold">Hubungi Kami</h3>
            <p>marselinusswen1@googlemail.com</p>
            <p>Jl. Microwave, Gunung Gajah</p>
            <p>Lahat</p>
          </div>
          <div class="mb-12 w-full px-4 md:w-1/3">
            <h3 class="mb-5 text-xl font-semibold text-white">Website Alternative</h3>
            <ul class="text-slate-300">
              <li>
                <a href="https://swenson.my.id" class="mb-3 inline-block text-base hover:text-primary">Web Utama</a>
              </li>
              <li>
                <a href="https://roother.my.id" class="mb-3 inline-block text-base hover:text-primary">Roother Web</a>
              </li>
              <li>
                <a href="https://shoukosagiri.com" class="mb-3 inline-block text-base hover:text-primary">ShoukoSagiri Web</a>
              </li>
            </ul>
          </div>
          <div class="mb-12 w-full px-4 md:w-1/3">
  ...
  <path d="M16 8A8 8 0 1 1 0 8a8 8 0 0 1 16 0zM8.287 5.906c-.778.324-2.334.994-4.666 2.01-.378.15-.577.298-.595.442-.03.243.275.339.69.47l.175.055c.408.133.958.288 1.243.294.26.006.549-.1.868-.32 2.179-1.471 3.304-2.214 3.374-2.23.05-.012.12-.026.166.016.047.041.042.12.037.141-.03.129-1.227 1.241-1.846 1.817-.193.18-.33.307-.358.336a8.154 8.154 0 0 1-.188.186c-.38.366-.664.64.015 1.088.327.216.589.393.85.571.284.194.568.387.936.629.093.06.183.125.27.187.331.236.63.448.997.414.214-.02.435-.22.547-.82.265-1.417.786-4.486.906-5.751a1.426 1.426 0 0 0-.013-.315.337.337 0 0 0-.114-.217.526.526 0 0 0-.31-.093c-.3.005-.763.166-2.984 1.09z"/>
          ...
          <p class="text-center text-xs font-medium text-slate-500">
            Copyright ©2021-2022 Swenson's Portfolio. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
